...
class SecondActivity : AppCompatActivity() {
    ...
    private fun goToInstallActivity() {
        ...
        if (isCompanionInstalled()) {
            // If system uninstall dialog is showing do not relaunch companion.
            // Relaunching with FLAG_ACTIVITY_CLEAR_TASK dismisses the dialog.
            if (MainActivity.isUninstalling) {
                return
            }
            launchCompanionApp()
            return
